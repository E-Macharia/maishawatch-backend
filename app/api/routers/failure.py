...
def failure_24h(data:EquipmentFeatures,u=Depends(optional_user)):
    e=_check(data,u)
...
def failure_72h(data:EquipmentFeatures,u=Depends(optional_user)):
    e=_check(data,u)
...
def failure_168h(data:EquipmentFeatures,u=Depends(optional_user)):
    e=_check(data,u)
